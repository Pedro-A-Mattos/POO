...
from loja import app, db, photos, search, bcrypt, login_manager
...
def customer_register():
    ...
    if form.validate_on_submit():
        ...
        register = models.User(name=form.name.data, username=form.username.data, email=form.email.data,
...
def get_order():
    if current_user.is_authenticated:
        ...
        try:
            ...
            print(e)
            flash('Algo deu errado ao obter o pedido', 'danger')
...
def orders(invoice):
    if current_user.is_authenticated:
        ...
        subTotal = 0
        customer_id = current_user.id
        customer = models.User.query.filter_by(id=customer_id).first()
